...
file_path ="scripts/pathway_pipeline.py"
dir_path ="picrust2"
...
#ファイルに内容を書き込む
    path = Path(f'/Users/yamadanaruto/research_git/{dir_path}/mothertests/codeing/{times[i]}.py')
...
folder_path = Path(f"/Users/yamadanaruto/research_git/{dir_path}/mothertests/codeing")
